...
class ConversationGenerator(ABC):
    @abstractmethod
    def build_conversation(self, messages, **kwargs) -> Response:
        raise NotImplementedError

    @abstractmethod
    def batch_build_conversation(self, list_of_messages, **kwargs) -> Generator[Response, None, None]:
        raise NotImplementedError


@dataclass
class HFConversationGenerator(ConversationGenerator):
    """
...
@dataclass
class AzureConversationGenerator(ConversationGenerator):
    """
...
@dataclass
class VLLMConversationGenerator(ConversationGenerator):
    """
